...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    -- NOTE: nvim-treesitter rewrote its API on the `main` branch.
    -- `nvim-treesitter.configs` no longer exists; use the new API instead.
    config = function()
      local ts = require 'nvim-treesitter'

      -- Install missing parsers asynchronously (no-op if already installed)
      local ensure = { 'bash', 'python', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' }
    ...
    -- There are additional nvim-treesitter modules you can explore:
...
vim.o.foldmethod = 'indent' -- Set the fold method to indent
